...
brew "curl"            # To get newest version available.
brew "exa"             # Modern replacement for `ls`. (https://github.com/ogham/exa)
...
brew "ykman"           # YubiKey manager CLI (https://developers.yubico.com/yubikey-manager/)
